...
namespace cAlgo.Robots
{
    ...
    public class PythonSignalBot : Robot
    {
        ...
        [Parameter("ShortThreshold", DefaultValue = 0.001)]
        ...
        private double PDCC = 0;
        private double OSV = 0;
        ...
        protected override void OnTick()
        {
            ...
            if (direction == "down"){
                ...
                if (askPrice > maxPrice){
                    maxPrice = askPrice;
                    //Tracking to see if ask price goes above threshold for short position
                    OSV = (double)((askPrice-PDCC) / PDCC)/Threshold;
                    if (OSV >= ShortThreshold){
